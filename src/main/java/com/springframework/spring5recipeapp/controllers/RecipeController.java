...
public class RecipeController {
    ...
    // @Valid is to validate this controller method
    // attributes of form are automatically bound to RecipeCommand by the help of naming convention
    // BindingResult provides result of form to POJO data binding
    // @ModelAttribute is to repopulate form in case of binding errors
    @PostMapping("recipe")
